            ...
            ? (
              ...
              <div className="cards">
                ...
                <div className="button-section">
                  < button className="addtocart" onClick={(e => { addToCart(item._id) })}>add to cart </button>
                  <Link to={`/productDetail/${item._id}`} key={item._id} style={{ textDecoration: 'none' }}>
                  < button className="view" onClick={(e => { addToCart(item._id) })}>product detail </button>
                    </Link>
                  {/* < MdFavoriteBorder className="view" onClick={(e => { addToCart(item._id) })}/>  */}
